...
$(document).ready(function() {
    console.log("app.js cargado. Conectando con el backend PHP.");
    ...
    async function fetchArtworks(searchTerm = '', styleFilter = '', artistFilter = '') {
        ...
        let url = 'backend/api/artworks.php';
    ...
    async function loadFilterOptions() {
        try {
            // Suponiendo que tienes un endpoint en tu backend para obtener estilos
            ...
            // Suponiendo que tienes un endpoint en tu backend para obtener artistas
